...
def parse_args():
    ...
    parser.add_argument("--alg", type=str, default="QAOA+", help="name of algorithm to use")
    parser.add_argument(
    ...
    parser.add_argument("--sim", type=str, default="qasm", help="Choose the simulation backend")
...
def main():
    ...
    for graphfn in all_graphs:
        ...
        for Lambda in np.arange(0.1, 10, 0.7):
            ...
            print(
                "lambda: {:.3f}, ratio = {:.3f}, rank = {}, prob = {:.3f}".format(
        ...
        # Save the results
        savename = "{}_{}_P{}_{}.pickle".format(graphname, args.alg, args.P, args.sim)
